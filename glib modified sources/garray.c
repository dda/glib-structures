...
// ======================================================================
/* Addition by dda@sungnyemun.org */

int compare_strings(gpointer a, gpointer b) {
  void *x = malloc(65536);
  void *y = malloc(65536);
  memcpy(x, a, 65535);
  memcpy(y, b, 65535);
...
int compare_singles(gpointer a, gpointer b) {
 float* x = (float*)a;
 float* y = (float*)b;
 return (int)*x - *y;
}

int compare_doules(gpointer a, gpointer b) {
 double* x = (double*)a;
 double* y = (double*)b;
 return (int)*x - *y;
}
...
int compare_int64(gpointer a, gpointer b) {
 long* x = (long*)a;
 long* y = (long*)b;
 return (int)(*x - *y);
}

int compare_uint64(gpointer a, gpointer b) {
 unsigned long* x = (unsigned long*)a;
 unsigned long* y = (unsigned long*)b;
 return (int)(*x - *y);
}

void g_array_sortSingle(GArray *array){
  g_array_sort(array, (GCompareFunc)compare_singles);
}

void g_array_sortDouble(GArray *array){
  g_array_sort(array, (GCompareFunc)compare_doules);
}

void g_array_sortInt(GArray *array){
  g_array_sort(array, (GCompareFunc)compare_ints);
}

void g_array_sortInt64(GArray *array){
  g_array_sort(array, (GCompareFunc)compare_int64);
}

void g_array_sortUInt64(GArray *array){
  g_array_sort(array, (GCompareFunc)compare_int64);
}

void g_array_sortString(GArray *array){
  g_array_sort(array, (GCompareFunc)compare_strings);
}


/* End of addition by dda@sungnyemun.org */
